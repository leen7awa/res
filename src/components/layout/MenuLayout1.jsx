...
const MenuLayout1 = ({ expandedId, toggleCollapse, setChosenCategory, setChosenWindow }) => {
                    ...
                    <div key={mainMenuItem.id} className="mb-4">
                        {expandedId !== mainMenuItem.id && (
                            ...
                            >
                                ...
                                <i className="absolute right-0 pt-1 text-xs fa fa-plus"></i>
                            </button>
                        )}
                        {expandedId === mainMenuItem.id && (
                            <div
                                className="overflow-y-auto max-h-40 transition-all duration-300 ease-in-out h-auto bg-slate-100"
                            >
